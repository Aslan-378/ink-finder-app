...
Request.create!(name: 'Joesephineepoo', location: 'Narnia', body_part: 'shoulder', size: '1 inches', style: 'Narnian', description: 'i lost a dare', user: user1, client: user2)
Request.create!(name: 'The Dude', location: 'London', body_part: 'chest', size: 'whole body', style: 'geometric', description: 'i am the dude, this means i will become one with tattoo', user: user1, client: user2)
puts "creating bookings"
Booking.create!(date: DateTime.new(2001,2,3,4,5,6), price: 600, location: 'SE17 2NF, London', request: Request.first, user: user1, client: user2 )
Booking.create!(date: DateTime.new(2001,2,3,4,5,6), price: 600, location: 'SE5 0ED, London', request: Request.last, user: user1, client: user2 )
puts "Finished!"
