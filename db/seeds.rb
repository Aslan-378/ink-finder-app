...
user6 = User.create!(email: 'z@me.com', password: '123456', first_name: 'Sam', last_name: 'Exotic', artist: true, style: 'lazer', price: 90, address: 'SE17 1JL, London', bio: "Really good japanese style", instagram: 'FreakOut!', nickname: "Songs")
user7 = User.create!(email: 'p@me.com', password: '123456', first_name: 'Tim', last_name: 'Exotic', artist: true, style: 'BigCatz', price: 20, address: 'SE17 1JL, London', bio: "Really good style", instagram: 'FallBack!', nickname: "Helmz")
user8 = User.create!(email: 'q@me.com', password: '123456', first_name: 'Fred', last_name: 'Exotic', artist: true, style: 'Japanese', price: 40, address: 'SE17 1JL, London', bio: "Really wacky design", instagram: 'BloodHasBeenSpiltThisNight!', nickname: "Legolas")
user9 = User.create!(email: 'r@me.com', password: '123456', first_name: 'Ellie', last_name: 'Exotic', artist: true, style: 'Angelic', price: 1000, address: 'SE17 1JL, London', bio: "crazy stuuf i do", instagram: 'TheirTakingTheHobbitsToIsengard!', nickname: "Urukhai")
user10 = User.create!(email: 's@me.com', password: '123456', first_name: 'June', last_name: 'Exotic', artist: true, style: 'Cubez', price: 990, address: 'SE17 1JL, London', bio: "really excited about tattoooos", instagram: 'Gandaaaalf!', nickname: "Wizaard")
